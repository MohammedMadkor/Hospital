...
<body>
    ...
    <form method="POST" action="{{url('staff/edit',$doctor->id)}}" enctype="multipart/form-data">
        @csrf
        <h4>Update Doctor</h4>
        <div class="mb-3">
            ...
            <select class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example"
                ...
                @foreach ($shift as $s)
                <option {{$doctor->shift_id == $s->id ? "selected" : ''}} value="{{$s->id}}">{{$s->name}}</option>
                @endforeach
        ...
        <div class="mb-3">
            ...
            <select class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example"
                ...
                <option {{$doctor->department_id == $d->id ? 'selected' : '' }} value="{{$d->id}}">{{$d->name}}</option>
                @endforeach
            </select>
            @error('department_id')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="name" value="{{$doctor->name}}">
            @error('name')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="national_id" value="{{$doctor->national_id}}">
            @error('national_id')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="phone" value="{{$doctor->phone}}">
            @error('phone')
        ...
        <div class="mb-3">
            ...
            <select class="form-select form-control form-select-lg mb-3" aria-label=".form-select-lg example" name="gender">
                ...
                <option {{$doctor->gender == 1 ? 'selected' : ''}} value="1">male</option>
                    <option {{$doctor->gender == 2 ? 'selected' : ''}} value="2">female</option>

            </select>
        </div>
        <div class="mb-3">
            <label for="text1" class="form-label">Age</label>
            <input type="number" class="form-control" id="text1" aria-describedby="emailHelp" name="age" value="{{$doctor->age}}">
            @error('age')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="address" value="{{$doctor->address}}">
            @error('address')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="salary" value="{{$doctor->salary}}">
            @error('salary')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="text1" aria-describedby="emailHelp" name="about" value="{{$doctor->about}}">
            @error('about')
        ...
        <a> <button type="submit" class="btn btn-primary"><span>Save Changes</span></button></a>
    </form>
