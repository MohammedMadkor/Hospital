...
<html lang="en">
  ...
  <body>
    hello {{$patient->name}}
    <img src="{{$patient->image}}" alt="" width="100px" height="100px">
    <br>
    <br>
...
<div class="col-md-4">
    <div class="card p-3">
        ...
        <div class="card-body text-center">
            ...
            <h5 class="card-title "> {{ $d->Department->name }}</h5>
            <a href="{{url('patientadmin/profiledoctor',$d->id)}}">view profile</a>
            <br>
            <a href="{{url('patientadmin/appointment',$d->id)}}">appointemt</a>
