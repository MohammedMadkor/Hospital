...
<div class="container1">
   ...
   <div class="text">
     <p >{{$doctor->name}}</p>
     <p class="chcolor" ><span>Department</span> {{$doctor->Department->name}}</p>
     <p>About</p>
     <p class="chcolor">{{$doctor->about}}</p>
     <a href="{{url('patientadmin/appointment',$doctor->id)}}"><button>Book Appointment</button></a>
   </div>
</div>
