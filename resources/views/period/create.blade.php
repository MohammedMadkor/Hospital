...
<body>
    ...
    <div class="card-body">
        <form method="post" action="{{url('period/store')}}">
            @csrf
            ...
            <div class="mb-3">
            <label for="period_number" class="form-label">period_number</label>
            <input type="text" class="form-control" id="period_number" name="period_number">
            @error('period_number')
            <span class="text-danger err-msg-period_number" role="alert">
                <strong>
                    {{$message}}
                </strong>
            </span>
