...
<div class="container">
    <div class="table-responsive">
        <h3 class="text-center mt-5">pharmacy</h3>
    ...
    <td class=" py-3">
        <div class=" ">
            <a href="{{url('pharmacy/medcine',$prescription->id)}}" class="text-decoration-none "><button type="button" class="link-Prescription ">view Medcine</button></a>
        </div>
