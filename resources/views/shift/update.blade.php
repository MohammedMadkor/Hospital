...
<body>
    ...
    <div class="card-body">
        <form method="POST" action="{{url('shift/edit',$shift->id)}}">
            @csrf
         <div class="mb-3">
         ...
         <div class="mb-3">
            ...
            <input type="number" class="form-control" id="start" name="start" value="{{$shift->start}}">
            @error('start')
...
@enderror
         ...
         <div class="mb-3">
            ...
            <input type="number" class="form-control" id="end" name="end" value="{{$shift->end}}">
